...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="../assets/admin/fonts/fontawesome-free-6.1.0-web/css/all.min.css">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b></b>MenDoVer</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="../assets/admin/images/Hung.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">Your name</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="../assets/admin/images/Hung.jpg" class="img-circle" alt="User Image">
        ...
        <section class="sidebar">
          ...
          <!-- /.search form -->
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="header">ADMIN HĐH</li>

                <li>
                    <a href="index.php?controller=categories">
                        <i class="fa-solid fa-calendar"></i> <span>Danh mục sản phẩm</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=supplies">
                ...
                <li>
                    <a href="index.php?controller=users">
                        <i class="fa-solid fa-user"></i> <span>Quản lý tài khoản</span>
                    </a>
                </li>
                <li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; by Hoang Duc Hung <a href="https://adminlte.io">AdminLTE</a>.</strong> All rights
        reserved.
    </footer>
