<?php 
	trait SuppliesModel{
		...
		public function modelUpdate($id){
			...
			$conn = Connection::getInstance();
			$query = $conn->prepare("update products set name =:var_name, category_id=:var_category_id, name_nsx=:var_name_nsx, in_price=:var_in_price, out_price=:var_out_price, weight=:var_weight, amount=:var_amount , description=:var_description, content=:var_content where id=:var_id");
		...
		public function modelCreate(){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert into products set name =:var_name, category_id=:var_category_id, name_nsx=:var_name_nsx, in_price=:var_in_price, out_price=:var_out_price, weight=:var_weight, amount=:var_amount , description=:var_description, content=:var_content ,photo = :var_photo");
